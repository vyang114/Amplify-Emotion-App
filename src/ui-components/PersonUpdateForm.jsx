...
export default function PersonUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setBoxColour(cleanValues.boxColour);
    setPhysicalSignal(
      typeof cleanValues.physicalSignal === "string"
        ? cleanValues.physicalSignal
        : JSON.stringify(cleanValues.physicalSignal)
    );
    setSocialIdentity(
      typeof cleanValues.socialIdentity === "string"
        ? cleanValues.socialIdentity
        : JSON.stringify(cleanValues.socialIdentity)
    );
    setEmotion(cleanValues.emotion);
    setSocialRelation(
      typeof cleanValues.socialRelation === "string"
    ...
    setEnvironment(
      typeof cleanValues.environment === "string"
        ? cleanValues.environment
        : JSON.stringify(cleanValues.environment)
    );
    setErrors({});
  };
